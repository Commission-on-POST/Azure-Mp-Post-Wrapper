...
import { CSSMediaWrapper } from "./mediaCSS";
import { PlayerDefaultProps, PlayerProps } from "./models/MediaPlayerProps";
...
export class MediaPlayer extends React.Component<PlayerProps> {
